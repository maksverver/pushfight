...
BINARIES=count-bits count-impossible print-perm solve-r0 solve-r1 solve-rN solve-lost verify-r0 print-r1
TESTS=perms_test
...
count-impossible: count-impossible.cc $(COMMON_OBJS)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDLIBS)
